...
<p class="dash-lable mb-0 bg-success bg-opacity-10 text-success rounded-2">Pengajuan Diterima</p>
...
<p class="dash-lable mb-0 bg-success bg-opacity-10 text-success rounded-2">Pengembalian Diterima</p>
